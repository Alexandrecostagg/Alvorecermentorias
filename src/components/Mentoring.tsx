  ...
  const mentoringPlans = [
    {
      ...
      period: '/mês',
      image: '/mentoring-homem-valor.png',
      rating: 5.0,
      reviews: 89,
      features: [
    ...
    },
    {
      ...
      period: '/mês',
      image: '/mentoring-mulheres-restauradas.png',
      rating: 4.9,
      reviews: 120,
      features: [
        '8 encontros coletivos online (1h30-2h)',
  ...
  const testimonials = [
    {
      ...
      content:
        'A Mentoria "Homens de Valor" transformou minha visão de vida e fé. Encontrei direção e um propósito real em Cristo. Recomendo demais!',
      rating: 5,
    ...
    },
    {
      ...
      content:
        'Participei da Mentoria "Mulheres Restauradas" e foi um divisor de águas. Minha fé foi fortalecida e me sinto mais perto de Deus. Gratidão!',
      rating: 5,

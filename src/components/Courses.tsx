...
import CourseCard from './CourseCard'; // Certifique-se de que este componente existe e está correto.
...
const Courses: React.FC = () => {
  const courses = [
    {
      ...
      price: 'R$ 69,90',
      image: '/course-homem-deus.jpg', // Corrigido para .jpg
      rating: 5.0,
      reviews: 180,
      students: 3100,
      lessons: 10,
    ...
    },
    {
      ...
      price: 'R$ 69,90',
      image: '/course-verdade-revelada.jpg', // Corrigido para .jpg
      rating: 4.9,
      reviews: 150,
      students: 2800,
      lessons: 12,
    ...
    },
    {
      ...
      price: 'R$ 69,90',
      image: '/course-principios-fe.jpg', // Corrigido para .jpg
      rating: 4.8,
      reviews: 110,
      students: 2100,
      lessons: 8,
    ...
    },
    {
      ...
      price: 'R$ 69,90',
      image: '/course-missionario-deus.jpg', // Corrigido para .jpg
      rating: 5.0,
      reviews: 95,
      students: 1500,
      lessons: 10,
    ...
    },
    {
      ...
      price: 'R$ 69,90',
      image: '/course-financas-biblia.jpg', // Corrigido para .jpg
      rating: 4.7,
      reviews: 80,
      students: 1900,
      lessons: 7,
    ...
    },
    {
      ...
      price: 'R$ 69,90',
      image: '/course-teologia-leigos.jpg', // Corrigido para .jpg
      rating: 4.9,
      reviews: 70,
      students: 1600,
      lessons: 9,
    ...
    },
    {
      ...
      price: 'R$ 109,90',
      image: '/course-mulheres-restauradoras.png', // Este já era .png
      rating: 5.0,
      reviews: 120,
      students: 2300,
      lessons: 10,
  ...
  return (
    <section id="courses" className="py-20 bg-gradient-to-b from-white to-amber-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Aprofunde-se na Palavra de Deus e cresça em conhecimento e fé com nossos cursos interativos
          </p>
        </div>

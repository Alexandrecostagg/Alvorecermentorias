// src/components/ProductSections.tsx
  ...
  const products = [
    {
      ...
      image: 'https://images.pexels.com/photos/339620/pexels-photo-339620.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
      rating: 4.9,
      reviews: 150,
      type: 'Livro',
      badge: 'Mais Vendido'
    },
    {
      ...
      price: 'R$ 29,90',
      image: 'https://images.pexels.com/photos/1034655/pexels-photo-1034655.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
      rating: 4.8,
      reviews: 90,
      type: 'Devocional',
      badge: 'Novo' 
    ...
    // Incluindo os lançamentos aqui também para o "Todos os Recursos"
    {
      id: 7, 
    ...
    },
    {
      ...
      subtitle: 'Aula online com Alexandre Gomes: Estratégias bíblicas e práticas.',
      price: 'R$ 9,99',
